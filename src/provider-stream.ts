...
import { isSyntheticVerificationTool } from './provider-protocol.js';
import {
  ThinkTagStreamParser,
  parseSseLine,
  type QueuedToolCall,
  type StreamSink,
} from './chat/infrastructure/sse-reader.js';
import { processChatCompletionsEvent } from './chat/infrastructure/chat-completions-parser.js';
import { processResponsesEvent } from './chat/infrastructure/responses-parser.js';
import { buildUsagePayload } from './chat/infrastructure/token-usage-reporter.js';
